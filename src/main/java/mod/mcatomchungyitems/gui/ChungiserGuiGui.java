...
package mod.mcatomchungyitems.gui;
...
import mod.mcatomchungyitems.procedures.ChungusiserUpdateGUIProcedure;
import mod.mcatomchungyitems.procedures.ChungusTakeOutInputProcedure;
import mod.mcatomchungyitems.procedures.ChugusiserInputItemProcedure;
...
public class ChungiserGuiGui extends ChungyitemsModElements.ModElement {
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("chugusiser_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, ChugusiserGuiGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 151, 44) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote()) {
				ChungyitemsMod.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	private static void handleSlotAction(PlayerEntity entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		if (slotID == 0 && changeType == 0) {
			{
				...
				ChugusiserInputItemProcedure.executeProcedure($_dependencies);
			}
		}
		if (slotID == 0 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				ChungusTakeOutInputProcedure.executeProcedure($_dependencies);
			}
		}
		...
		if (slotID == 6 && changeType == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				ChungusiserUpdateGUIProcedure.executeProcedure($_dependencies);
			}
		}
