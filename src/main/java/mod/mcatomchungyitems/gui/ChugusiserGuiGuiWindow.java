...
public class ChugusiserGuiGuiWindow extends ContainerScreen<ChugusiserGuiGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("chungyitems:textures/chugusiser_gui.png");
	@Override
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Chungusiser", 60, 7, -12829636);
	}
